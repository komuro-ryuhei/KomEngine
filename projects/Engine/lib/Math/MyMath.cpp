...
// 加算(Vector3)
Vector3 MyMath::Add(const Vector3& v1, const Vector3& v2) { return Vector3(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z); }
...
// 減算(Vector3)
Vector3 MyMath::Subtract(const Vector3& v1, const Vector3& v2) { return Vector3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z); }
...
// 積(Vector3)
Vector3 MyMath::Multiply(const Vector3& v1, const Vector3& v2) { return Vector3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z); }
...
// 　スカラー倍(Vector3)
Vector3 MyMath::Multiply(float scalar, const Vector3& v) { return Vector3(scalar * v.x, scalar * v.y, scalar * v.z); }
